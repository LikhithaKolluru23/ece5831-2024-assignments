...
class MnistData():
    """ A class to handle the MNIST dataset: downloading, processing, and loading it"""
    image_dim = (28, 28)
    ...
    def __init__(self):
        """
        Initializes the MnistData object. Checks if the dataset directory exists, 
        and creates it if necessary. Loads the dataset from the pickle file if available, 
        or downloads and processes the dataset if the pickle file does not exist.
        """
        self.dataset = {}
    ...
    def _change_one_hot_label(self, y, num_class):
        """Converts a label array into one-hot encoding. """
    ...
    def _download(self, file_name):
        """ Downloads a file from the dataset if it does not already exist in the dataset directory."""
    ...
    def _download_all(self):
        """ 
        Downloads all the necessary files (images and labels) for the MNIST dataset.
        """
    ...
    def _load_images(self, file_name):
        """Loads image data from a gzipped file """
    ...
    def _load_labels(self, file_name):
        """Loads label data from a gzipped file """
        with gzip.open(file_name, 'rb') as f:
    ...
    def _create_dataset(self):
        """Creates the MNIST dataset by loading images and labels, normalizing them, 
        and saving the dataset as a pickle file """
    ...
    def _init_dataset(self):
        """
        Initializes the dataset by either loading it from an existing pickle file 
        or downloading, processing, and creating the dataset if the pickle file does not exist.
        """
        self._download_all()
    ...
    def load(self):
        """ Loads the MNIST dataset, normalizes the image data, and applies one-hot encoding to the labels."""
